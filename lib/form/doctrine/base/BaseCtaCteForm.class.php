...
/**
 * CtaCte form base class.
 *
 * @method CtaCte getObject() Returns the current form's model object
 *
 * @package    odontopc
 * @subpackage form
 ...
 */
abstract class BaseCtaCteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cta_cte[%s]');
