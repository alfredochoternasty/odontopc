...
/**
 * DetalleFactcompra form base class.
 *
 * @method DetalleFactcompra getObject() Returns the current form's model object
 *
 * @package    odontopc
 * @subpackage form
 ...
 */
abstract class BaseDetalleFactcompraForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('detalle_factcompra[%s]');
