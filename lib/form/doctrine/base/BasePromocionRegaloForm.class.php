...
/**
 * PromocionRegalo form base class.
 *
 * @method PromocionRegalo getObject() Returns the current form's model object
 *
 * @package    odontopc
 * @subpackage form
 ...
 */
abstract class BasePromocionRegaloForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('promocion_regalo[%s]');
