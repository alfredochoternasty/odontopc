...
/**
 * CompFact form base class.
 *
 * @method CompFact getObject() Returns the current form's model object
 *
 * @package    odontopc
 * @subpackage form
 ...
 */
abstract class BaseCompFactForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('comp_fact[%s]');
