...
/**
 * DetallePedidoOriginal form base class.
 *
 * @method DetallePedidoOriginal getObject() Returns the current form's model object
 *
 * @package    odontopc
 * @subpackage form
 ...
 */
abstract class BaseDetallePedidoOriginalForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('detalle_pedido_original[%s]');
