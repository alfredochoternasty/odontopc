...
/**
 * DetallePedidoOriginal filter form base class.
 *
 * @package    odontopc
 * @subpackage filter
 ...
 */
abstract class BaseDetallePedidoOriginalFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('detalle_pedido_original_filters[%s]');
