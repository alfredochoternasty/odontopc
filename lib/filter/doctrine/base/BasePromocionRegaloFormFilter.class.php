...
/**
 * PromocionRegalo filter form base class.
 *
 * @package    odontopc
 * @subpackage filter
 ...
 */
abstract class BasePromocionRegaloFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('promocion_regalo_filters[%s]');
