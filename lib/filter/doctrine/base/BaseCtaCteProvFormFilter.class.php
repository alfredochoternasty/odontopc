...
/**
 * CtaCteProv filter form base class.
 *
 * @package    odontopc
 * @subpackage filter
 ...
 */
abstract class BaseCtaCteProvFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cta_cte_prov_filters[%s]');
