 ...
 */
abstract class BaseEnvioFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'fecha_salida'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'fecha_llegada'   => new sfWidgetFormFilterInput(),
      'nro_seguimiento' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'fecha_salida'    => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'fecha_llegada'   => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'nro_seguimiento' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'comprobante'     => new sfValidatorPass(array('required' => false)),
      'observacion'     => new sfValidatorPass(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('envio_filters[%s]');
