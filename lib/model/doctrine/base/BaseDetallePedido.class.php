...
Doctrine_Manager::getInstance()->bindComponent('DetallePedido', 'doctrine');
 ...
 */
abstract class BaseDetallePedido extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('detalle_pedido');
