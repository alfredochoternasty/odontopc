...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><a href="<?php echo url_for('cliente/show?id='.$sf_guard_user->getId()) ?>"><?php echo $sf_guard_user->getId() ?></a></td>
      ...
      <td><?php echo $sf_guard_user->getEsCliente() ?></td>
      <td><?php echo $sf_guard_user->getZonaId() ?></td>
