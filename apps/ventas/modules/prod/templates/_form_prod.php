...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@producto', array('id' => 'form_producto')) ?>
    ...
    endforeach; 
	    ...
	    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
	      <?php include_partial('prod/form_fieldset', array('producto' => $producto, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
	    <?php endforeach; ?>
		</div>
