...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@pedido', array('id' => 'form_pedido')) ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('ped/form_actions', array('pedido' => $pedido, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
    ...
    endforeach; 
	    ...
	    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
	      <?php include_partial('ped/form_fieldset', array('pedido' => $pedido, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
	    <?php endforeach; ?>
		</div>
