...
<div id="sf_admin_container" class="sf_admin_edit ui-widget ui-widget-content ui-corner-all">
  <div class="fg-toolbar ui-widget-header ui-corner-all">
    <h1><?php echo __('Cargar contacto al Cliente', array(), 'messages') ?></h1>
  </div>
  ...
  <div id="sf_admin_content">
    <?php include_partial('cliseg/form_cargar', array('cliente_seguimiento' => $cliente_seguimiento, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>
