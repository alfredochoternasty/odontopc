...
<div id="sf_admin_container" class="sf_admin_edit ui-widget ui-widget-content ui-corner-all">
  <div class="fg-toolbar ui-widget-header ui-corner-all">
    <h1><?php echo __('Nuevo Detalle de la compra %%Compra%%', array('%%Compra%%' => $detalle_compra->getCompra()), 'messages') ?></h1>
  </div>
  ...
  <div id="sf_admin_content">
    ...
    <?php
      if(count($pager2) > 0):
        include_partial('detcomp/detalle', array('pager2' => $pager2, 'sort' => array('producto', 'asc'), 'helper' => $helper));
      endif;
    ?>    
  </div>
