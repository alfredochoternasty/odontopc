...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@banco', array('id' => 'form_banco')) ?>
    ...
    endforeach; 
	    ...
	    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
	      <?php include_partial('banco/form_fieldset', array('banco' => $banco, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
	    <?php endforeach; ?>
		</div>
