<?php if ($curso->getHabilitado() == 'SI'){ ?>
  ...
  <?php } ?>
  <h2 style="text-decoration:underline; color:#d91103; font-family: verdana; padding-left:10px;"><?php echo $curso->getNombre() ?></h2>
  ...
  <ul style="font-family: verdana;">
    <li><strong>Fecha: </strong><?php echo $curso->getFecha() ?> <strong>- Hora: </strong><?php echo $curso->getHora() ?></li>
