...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_header">
    <?php include_partial('listvta/list_header', array('pager' => $pager)) ?>
  </div>
  ...
  <div id="sf_admin_content">
      ...
      <?php include_partial('listvta/list_filter', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper, 'hasFilters' => $hasFilters)) ?>
  ...
  <div id="sf_admin_footer">
    <?php include_partial('listvta/list_footer', array('pager' => $pager)) ?>
  </div>
