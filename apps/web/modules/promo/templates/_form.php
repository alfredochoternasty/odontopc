...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@promocion', array('id' => 'form_promocion')) ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('promo/form_actions', array('promocion' => $promocion, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
    ...
    endforeach; 
      ...
      <div id="sf_admin_form_tab_menu">
	    ...
	    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
	      <?php include_partial('promo/form_fieldset', array('promocion' => $promocion, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
	    <?php endforeach; ?>
		</div>
