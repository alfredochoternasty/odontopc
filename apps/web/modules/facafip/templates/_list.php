<div class="sf_admin_list ui-grid-table ui-widget ui-corner-all ui-helper-reset ui-helper-clearfix">
  ...
  <table>
    <caption class="fg-toolbar ui-widget-header ui-corner-top">
        ...
        <?php echo link_to(UIHelper::addIconByConf('reset') . __('Reset', array(), 'sf_admin'), 'facturas_afip_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'fg-button ui-state-default fg-button-icon-left ui-corner-right ui-state-disabled')) ?></span>
      </div>
            <h1><span class="ui-icon ui-icon-triangle-1-s"></span> <?php echo __('Listado de Facturas Enviadas a la Afip', array(), 'messages') ?></h1>
    </caption>
    <tbody>
  ...
  <table>
    <caption class="fg-toolbar ui-widget-header ui-corner-top">
        ...
        <?php echo link_to(UIHelper::addIconByConf('reset') . __('Reset', array(), 'sf_admin'), 'facturas_afip_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'fg-button ui-state-default fg-button-icon-left ui-corner-right'.$isDisabledResetButton)) ?></span>
      </div>
            <h1><span class="ui-icon ui-icon-triangle-1-s"></span> <?php echo __('Listado de Facturas Enviadas a la Afip', array(), 'messages') ?></h1>
    </caption>
    ...
    <thead class="ui-widget-header">
      <tr>
        ...
        <?php include_partial('facafip/list_th_tabular', array('sort' => $sort)) ?>
      ...
      <tr>
        <th colspan="7">
          <div class="ui-state-default ui-th-column ui-corner-bottom">
            <?php include_partial('facafip/pagination', array('pager' => $pager)) ?>
          </div>
        </th>
      </tr>
    </tfoot>
    ...
    <tbody>
      ...
      <?php foreach ($pager->getResults() as $i => $facturas_afip): $odd = fmod(++$i, 2) ? ' odd' : '' ?>
        <tr class="sf_admin_row ui-widget-content <?php echo $odd ?>">
          ...
          <?php include_partial('facafip/list_td_tabular', array('facturas_afip' => $facturas_afip)) ?>
