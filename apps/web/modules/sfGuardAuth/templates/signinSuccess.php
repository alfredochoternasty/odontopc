...
<div class="cabecera"><img src="<?php echo $base_url ?>/web/images/<?php echo $logo_login ?>"></div>
<?php echo get_partial('sfGuardAuth/signin_form', array('form' => $form)) ?>
<div id="registrarse">
	<a href="<?php echo url_for('@cliente_registro_new') ?>">Presione aqui para Registrarse</a>
</div>