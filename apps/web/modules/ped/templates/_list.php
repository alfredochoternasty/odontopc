<div class="sf_admin_list ui-grid-table ui-widget ui-corner-all ui-helper-reset ui-helper-clearfix">
  ...
  <table>
    <caption class="fg-toolbar ui-widget-header ui-corner-top">
        ...
        <?php echo link_to(UIHelper::addIconByConf('reset') . __('Reset', array(), 'sf_admin'), 'pedido_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'fg-button ui-state-default fg-button-icon-left ui-corner-right')) ?></span>
      </div>
  ...
  <table>
    <caption class="fg-toolbar ui-widget-header ui-corner-top">
      <div id="sf_admin_filters_buttons" class="fg-buttonset fg-buttonset-multi ui-state-default">
        ...
        <?php echo link_to(UIHelper::addIconByConf('reset') . __('Reset', array(), 'sf_admin'), 'pedido_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'fg-button ui-state-default fg-button-icon-left ui-corner-right'.$isDisabledResetButton)) ?></span>
      </div>
      <h1><span class="ui-icon ui-icon-triangle-1-s"></span> <?php echo __('Pedidos Pendientes', array(), 'messages') ?></h1>
    </caption>
    ...
    <thead class="ui-widget-header">
      <tr>        
        <?php include_partial('ped/list_th_tabular', array('sort' => $sort)) ?>
      ...
      <tr>
        <th colspan="5">
          <div class="ui-state-default ui-th-column ui-corner-bottom">
            <?php include_partial('ped/pagination', array('pager' => $pager)) ?>
          </div>
        </th>
      </tr>
    </tfoot>
    ...
    <tbody>
      <?php foreach ($pager->getResults() as $i => $pedido): $odd = fmod(++$i, 2) ? ' odd' : '' ?>
        <tr class="sf_admin_row ui-widget-content <?php echo $odd ?>">
          ...
          <?php include_partial('ped/list_td_tabular', array('pedido' => $pedido)) ?>

                      <?php include_partial('ped/list_td_actions', array('pedido' => $pedido, 'helper' => $helper)) ?>
                  </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
