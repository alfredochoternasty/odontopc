...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@compra2', array('id' => 'form_compra2')) ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('compras/form_actions', array('compra2' => $compra2, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
