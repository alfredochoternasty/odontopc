 ...
 */
class BaseComprasGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return '%%id%% - %%numero_compra%% - %%proveedor_id%% - %%fecha%% - %%producto_id%% - %%cantidad%% - %%nro_lote%%';
  }
  ...
  {
    return array(  0 => 'id',  1 => 'numero_compra',  2 => 'proveedor_id',  3 => 'fecha',  4 => 'producto_id',  5 => 'cantidad',  6 => 'nro_lote',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'numero_compra' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',),
      ...
      'nro_lote' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',),
    );
  }
