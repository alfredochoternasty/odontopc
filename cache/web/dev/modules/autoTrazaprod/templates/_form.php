...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@traza2', array('id' => 'form_traza2')) ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('trazaprod/form_actions', array('traza2' => $traza2, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
