...
<div class="sf_admin_form">
  <?php echo form_tag_for($form, '@cliente', array('id' => 'form_cliente')) ?>

    <div class="sf_admin_actions_block ui-widget">
      <?php include_partial('cli/form_actions', array('cliente' => $cliente, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
