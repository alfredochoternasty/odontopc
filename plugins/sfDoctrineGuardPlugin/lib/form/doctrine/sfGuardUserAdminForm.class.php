...
class sfGuardUserAdminForm extends BasesfGuardUserAdminForm
{
  ...
  public function configure()
  {
    ...
    $this->validatorSchema['zona_id'] = new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Zona'), 'required' => true));
    $this->validatorSchema['usuario_zona'] = new sfValidatorChoice(array('choices' => array(1,2,3,4,5,6), 'multiple' => true, 'required' => true));    
